...
print("\nDimensionless numbers and interacting with floats")
a = 45 * reg.dimensionless
b = 50 * reg.dimensionless
print(
    f"Dimensionless number a={a}, b={b}, a+b={a+b}, a*b={a*b}, a/b={a/b}, a*10={a*10}"
)
print(
    f"Dimensionless * unit: {a * reg.hour}, *ratio: {a * reg.Hz}, *product: {a*reg.kWh}"
)
